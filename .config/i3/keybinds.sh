...
# Resize windows
set $shrink_step 5
bindsym $mod+control+Left resize shrink width $shrink_step px or $shrink_step ppt
bindsym $mod+control+Down resize shrink height $shrink_step px or $shrink_step ppt
bindsym $mod+control+Up resize grow height $shrink_step px or $shrink_step ppt
bindsym $mod+control+Right resize grow width $shrink_step px or $shrink_step ppt
